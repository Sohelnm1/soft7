...
const message_service_1 = require("../src/services/message.service");
...
async function simulateMediaWebhook() {
    ...
    try {
        ...
        const acc = await prisma_1.prisma.whatsAppAccount.findFirst({
        ...
        const savedMsg = await message_service_1.MessageService.handleInbound(message, contact, metadata);
        ...
        const storedContact = await prisma_1.prisma.contact.findUnique({
